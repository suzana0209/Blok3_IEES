...
{	
	...
	public class ModelResourcesDesc
	{
        ...
        private void InitializeNotSettablePropertyIds()
		{
            ...
            notSettablePropertyIds.Add(ModelCode.DAYTYPE_SEASONDAYTYPESCHEDULES);
            notSettablePropertyIds.Add(ModelCode.REGULARINTERVALSCHEDULE_REGULARTIMEPOINTS);
            notSettablePropertyIds.Add(ModelCode.REGULATINGCONTROL_REGULATIONSCHEDULES);
            notSettablePropertyIds.Add(ModelCode.TAPCHANGER_TAPSCHEDULES);
        }
